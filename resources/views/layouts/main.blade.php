...
<body>
    <header class="bg-[#7E9796] text-white">
        <div class="flex justify-end gap-3 mr-4">
            <button id="btnAumentar" class= "text-white px-4 py-2 rounded-full text-xl border-2">A+</button>
            <button id="btnDiminuir" class="text-white px-4 py-2 rounded-full text-xl border-2">A-</button>
        </div>
    ...
    <script>
        ...
        // Lista de classes do Tailwind para tamanhos de texto
        const tamanhos = ['text-sm', 'text-base', 'text-lg', 'text-xl', 'text-2xl', 'text-3xl', 'text-4xl'];
        let indiceAtual = 1; // começa em text-base

        function atualizarTamanho() {
            conteudo.classList.remove(...tamanhos);
            conteudo.classList.add(tamanhos[indiceAtual]);
        }
